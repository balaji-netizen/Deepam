...
const footerLinks = {
  ...
  Engage: [
    ...
    { label: 'Order on WhatsApp', href: 'https://wa.me/918754322277' },
  ],
}
...
const socials = [
  {
    label: 'Instagram',
    href: 'https://www.instagram.com/kaleesuwari_refinery/?igshid=YmMyMTA2M2Y%3D',
  ...
  {
    label: 'Facebook',
    href: 'https://www.facebook.com/KALEESUWARI/',
    icon: <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" /> },
  {
    label: 'YouTube',
    href: 'https://www.youtube.com/@kaleesuwari',
  ...
  {
    label: 'LinkedIn',
    href: 'https://www.linkedin.com/company/kaleesuwari/',
    icon: <path d="M6.94 8.5A1.8 1.8 0 1 1 6.94 5a1.8 1.8 0 0 1 0 3.5ZM5.4 9.7h3.08v9.3H5.4v-9.3Zm5.2 0h2.96v1.28h.04c.41-.78 1.4-1.6 2.88-1.6 3.08 0 3.64 2.03 3.64 4.66v6.96h-3.08v-6.53c0-1.56-.03-3.56-2.17-3.56-2.17 0-2.5 1.69-2.5 3.43v6.66H10.6v-9.3Z" />,
  },
]
